    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_data', jsonfield.fields.JSONField(default=dict)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('id_role', models.ManyToManyField(to='cyberpolygonApp.role')),
                ('id_team', models.ManyToManyField(to='cyberpolygonApp.team')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category_id', models.ManyToManyField(to='cyberpolygonApp.category')),
                ('task_id', models.ManyToManyField(to='cyberpolygonApp.task')),
            ],
        ),
        migrations.CreateModel(
            name='UserAvatar',
